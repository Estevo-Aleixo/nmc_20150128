...
$(document).ready(function() {
    ...
    $("#submitButton").click(function() {
        ...
        var id = youtube_parse_id($('#youtube-id').val())
        if(id) {
            $("#youtube-video-button").html("");
            $.getJSON("ajax/get_info.php?id=" + id, function(data) {
                if(data == false) {
                    ...
                    if(data.error == true) {
                        ...
                        $("#youtube-video-button").html($('<div class="row"><a href="go.php?id='+id+'&edit=True"><div class="text-center col-md-12"><button class="btn-success btn btn-lg">'+data.title+'</button></div></a></div>'));
                    }
                }
